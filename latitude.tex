...
- Blockchains are the new vehicles for the data sharing economy by creating privacy aware, secure and user incentivized
ways of sharing data. New wave of applications in various industries are disrupting status quo.

Transportation industry has a large number of applications, users, regulations, which can benefit from data sharing if
    it can be done correctly.

 We present the Latitude blockchain, which is designed to be the best blockchain for all transportation applications,
    data and contracts.
