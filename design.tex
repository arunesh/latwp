...
contracts using multi-party key distribution protocols. We shall leverage existing MPC communication protocols in this
area to create a secret contract system similar to the one used in Enigma \cite{enigma}.
