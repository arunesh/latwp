...
Cryptographic primitives for:
 ...
 The cryptographic system can provide various proofs that can be used by applications, users and other participants. The
 proofs include the ones listed below but are not limited to these:
 \begin{itemize}
     ...
     \item Proof of driver score: 
     \item Proof of traffic : 
     \item Proof of routes : 
 \end{itemize}
