...
multi-party key distribution, proxy key re-encryption, Elliptic-curve based Digital Signatures \cite{ecdsa} and other
...
for geo-spatial, mapping, location and sensor data for driving. These proofs that can be used by applications, users and
...
grow. The proofs include the ones listed below but are not limited to these:
 ...
 \begin{itemize}
     ...
     \item Proof of driver score: This proof can be computed on the blockchain over the data aggregated on the
         ...
         open-source version. This allows different nodes to run the computation and create a certificate of a certain
